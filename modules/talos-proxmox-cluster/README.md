...
| <a name="input_rook"></a> [rook](#input\_rook) | n/a | <pre>object({<br/>    control_plane_enabled = optional(bool, false)<br/>    control_plane_size    = optional(number, "20")<br/>    nodes_enabled         = optional(bool, false)<br/>    nodes_size            = optional(number, "20")<br/>  })</pre> | n/a | yes |
| <a name="input_talos_control_plane"></a> [talos\_control\_plane](#input\_talos\_control\_plane) | n/a | <pre>object({<br/>    cores               = optional(number, 2)<br/>    memory              = optional(number, 4096)<br/>    static_networking   = optional(bool, false)<br/>    version             = optional(string, "1.9.1")<br/>    nodes               = optional(number, 3)<br/>    cluster_subnet      = string<br/>    cluster_subnet_cidr = optional(number, 24)<br/>    first_id            = number<br/>  })</pre> | n/a | yes |
...
| <a name="input_talos_node"></a> [talos\_node](#input\_talos\_node) | n/a | <pre>object({<br/>    cores               = optional(number, 2)<br/>    memory              = optional(number, 4096)<br/>    static_networking   = optional(bool, false)<br/>    version             = optional(string, "1.9.1")<br/>    nodes               = optional(number, 3)<br/>    cluster_subnet      = string<br/>    cluster_subnet_cidr = optional(number, 24)<br/>    first_id            = number<br/>  })</pre> | n/a | yes |
